        ...
        return(        
            <Container fluid className={"contact-s1 align-items-center p-0 d-flex minh-50vh "+this.props.classExt}>
                <Row className="mx-auto text-center w-100 pt-5">
                    <Col xs={12} sm={6} className="mx-auto text-dark p-0">
                    </Col>
                    <Col xs={12} sm={6} className="mx-auto text-white p-5 d-flex align-items-center text-shadow">
                        <Card className="w-100 text-center bg-brown border border-dark p-4 opacity-9">    
                            <h1 className="display-4 fw-bold font-logo text-white opacity-8">
                                Contact us
                            </h1>
